            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item dropdown no-arrow mr-5">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                  ...
                  <img class="img-profile rounded-circle" src="{{ asset('img/futu/logoweb1.png') }}" style="max-width: 60px">
                  <span class="ml-2 d-none d-lg-inline text-white small">Kantin</span>
                </a>
                ...
                <ol class="breadcrumb">
                 <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="reportDropdown">
                    <a class="dropdown-item" href="{{ route('kantin.laporan.transaksi') }}">
